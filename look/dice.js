...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-7cfce91f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-7cfce91f');}
...
function clearFlash(){dieView.classList.remove('rl-win-7cfce91f');dieView.classList.remove('rl-lose-7cfce91f');if(frameEl){frameEl.classList.remove('rl-win-7cfce91f');frameEl.classList.remove('rl-lose-7cfce91f');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-7cfce91f');if(frameEl){frameEl.classList.add('rl-win-7cfce91f');}}else{dieView.classList.add('rl-lose-7cfce91f');if(frameEl){frameEl.classList.add('rl-lose-7cfce91f');}}
...
var brandEl=document.querySelector('.rl-brand-7cfce91f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
